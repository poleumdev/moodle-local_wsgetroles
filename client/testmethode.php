...
$urlact = new moodle_url('/local/wsgetroles/client/testmethode.php', ['roleid' => $roelid]);
$PAGE->set_url($urlact);
...
echo ("Test information sur les roles<br/>");
...
if ($roleid != -1) {
    ...
    $shortnames = array();
    $shortnames[] ='student';
    $rs = local_wsgetroles_external::get_roles($roles, $shortnames);
    echo (json_encode($rs));
} else {
